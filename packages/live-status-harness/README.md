...
- `--provider opencode|claudecode|codex|kimi|qwen`
- `--cwd <path>`
- `--channel <id>`
- `--thread <id>`
- `--user <id>`
...
This runs capture + render for each provider (`opencode`, `claudecode`, `codex`, `kimi`, `qwen`).
...
- `--providers opencode,claudecode,codex,kimi,qwen`
