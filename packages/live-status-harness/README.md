...
- `--provider opencode|claudecode|codex|kimi|kiro`
- `--cwd <path>`
- `--channel <id>`
- `--thread <id>`
- `--user <id>`
...
This runs capture + render for each provider (`opencode`, `claudecode`, `codex`, `kimi`, `kiro`).
...
- `--providers opencode,claudecode,codex,kimi,kiro`
